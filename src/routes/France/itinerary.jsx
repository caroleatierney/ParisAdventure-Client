          ...
          <Slider {...settings}>
            <div className="relative min-h-[500px] w-full">
              <img
                ...
                src="https://i.imgur.com/7cXpwcT.jpg"
              ...
              <div className="bg-pink bg-opacity-30 backdrop-blur-md flex flex-col justify-center items-center pb-4 pt-2">
                ...
                <p className="text-sm text-gray-600 text-center">
                  We are going on a Luxury Canal Cruise booked through French
                  Country Waterways, Ltd. We will be travelling from
                  Saint-Leger-Sur-Dheune to Saint-Jean-De-Losne Adrienne is the
                  name of the barge we will be travelling on. We will be
                  exploring the Burgandy Region of France. The Vineyards of
                  Burgandy produce some of the world's most prized wines.
                </p>
              </div>
            </div>
            <div className="relative min-h-[500px] w-full">
            ...
            <div className="relative min-h-[500px] w-full">
              ...
              <div className="bg-pink bg-opacity-30 backdrop-blur-md flex flex-col justify-center items-center pb-4 pt-2">
                ...
                <p className="text-sm text-gray-600 text-center">
                  ...
                  After lunch, enjoy a walking tour of Dijon, starting in front
                  of the Ducal Palace, with time to browse in the fine specialty
